...
function App() {
  ...
  return (
    <div id='bodyWrapper' style={{backgroundImage:`url(${plaidPattern})`}}>
      ...
      <div id='mainWrapper' className='flex justify-center items-center w-full h-screen max-h-screen-lg max-h-[1000px]'>
        {IsUser ? (
          <>
            {/* <Gallary /> */}
            <Homepage />
          ...
          <div id='welcomeContainer' className='flex flex-col justify-between  text-justify p-4 md:w-1/2 lg:p-0 lg:pl-8'>
            <h1 className='font-[Lobster] my-2 text-[#424874] text-2xl md:text-3xl lg:text-5xl'>Welcome to&#160;
              <span className='font-[Lobster] bg-[#424874] text-white py-0 px-2'>Mel Bakes.
              </span>
            </h1>
            <p className='my-2 font-[Raleway] text-[#424874] text-xs lg:text-sm'>Every bite tells a story of freshness and flavor, Our deliciously baked cupcakes, cakes, and bread are crafted with the finest ingredients and a dash of love... Perfect for any occasion, Whether you’re celebrating a birthday wedding, holiday, or just indulging your sweet tooth, our delightful treats promise to bring joy and satisfaction. Discover the perfect blend of taste and quality with every order from Mel Bakes, your go-to destination for freshly baked goodness for all life's special moments.
            </p>

              <button className='w-max h-max self-center bg-[#424874] text-white px-4 py-2 rounded-sm' 
                onClick={()=> {
          ...
          <div id='gallaryContainer' className='flex flex-col justify-between  items-center md:w-1/2'>
      ...
      <div id='productWrapper' className='flex justify-center w-full h-max bg-[#a6b1e1]'>
        <div id='productWrapper__wrapper' className='grid grid-cols-1 grid-rows-[.5fr 9.5fr] max-w-7xl px-4 py-2 gap-6' >
          ...
          <div id='productContainerWrapper' className='py-4 px-8'>
            <h1>Cupcakes</h1>
            <div id='productContainer' className='row-span-2 flex flex-row justify-center flex-wrap gap-6'>
      ...
      <div id='footerWrapper' className='flex justify-center w-full h-max bg-[#393646]'>
        <FooterComponent />
      </div>
      <Outlet />
    </div>
